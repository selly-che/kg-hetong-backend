<template>
            ...
            <template #action="{ record }">
              <a-space>
                ...
                <a-popconfirm
                  ...
                  ok-text="确定"
                  cancel-text="取消"
                  @confirm="handleUserDelete(record)"
                >
  ...
  <div>
    ...
    <a-modal
      ...
      @ok="handleOk"
      :ok-button-props="{
        disabled: !formState.roleCode || !formState.roleName,
      }"
    >
      <a-form
        ref="formRef"
    ...
    <PermissionConfigDrawer
      ...
      :fetch-tree-api="fetchPermissionTree"
      :fetch-checked-api="fetchCheckedPermissions"
      :save-api="saveRolePermissions"
